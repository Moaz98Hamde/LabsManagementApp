...
@section('content')
    @include('users.partials.header', ['title' => __('Add Lab')])
        ...
        <div class="row">
            <div class="col-xl-12 order-xl-1">
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('lab.store') }}" autocomplete="off" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="pl-lg-4">
                                <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="name" id="input-lab" class="form-control form-control-alternative{{ $errors->has('name') ? ' is-invalid' : '' }}" placeholder="{{ __('Name') }}" value="{{ old('name') }}" required autofocus>
                                 ...
                                 <div class="form-group{{ $errors->has('location') ? ' has-danger' : '' }}">
                                   ...
                                   <div class="form-group{{ $errors->has('supervisor') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="supervisor" id="input-supervisor" class="form-control form-control-alternative{{ $errors->has('supervisor') ? ' is-invalid' : '' }}" placeholder="{{ __('supervisor') }}" value="{{ old('supervisor') }}" required autofocus>
